...
def cmd_up(args):
    ...
    if needs_amd64_platform():
        ...
        print("  dedicated server is an x86_64 binary, so this runs under")
        print("  emulation. On an ARM Mac that does not work at all — SteamCMD")
        print("  segfaults and the download never finishes. On ARM Linux with")
        print("  box64 it can work, but needs host setup first.")
        print("  See docs/valheim-on-arm.md before relying on this.\n")
